...
const variants: Record<Variant, string> = {
  primary:
    'bg-brand-gradient text-white border border-brand-400/30 shadow-[0_4px_14px_-4px_rgba(249,115,22,0.5)] hover:shadow-[0_6px_22px_-4px_rgba(249,115,22,0.7)] hover:brightness-110',
  secondary:
